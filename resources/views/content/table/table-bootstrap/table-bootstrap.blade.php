        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="card-text">
                    ...
                    Bootstrap. You
                    can use any example of below table for your table and it can be use with any type of bootstrap
                    tables.
                </p>
            </div>
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <img src="{{asset('images/icons/angular.svg')}}" class="me-75" height="20" width="20"
                                    alt="Angular" />
                        ...
                        <tr>
                            <td>
                                <img src="{{asset("images/icons/react.svg")}}" class="me-75" height="20" width="20"
                                    alt="React" />
                        ...
                        <tr>
                            <td>
                                <img src="{{asset('images/icons/vuejs.svg')}}" class="me-75" height="20" width="20"
                                    alt="Vuejs" />
                        ...
                        <tr>
                            <td>
                                <img src="{{asset('images/icons/bootstrap.svg')}}" class="me-75" height="20" width="20"
                                    alt="Bootstrap" />
                ...
                <table class="table table-dark">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="dropdown">
                                    <button type="button" class="btn btn-sm text-white dropdown-toggle hide-arrow py-0"
                                        data-bs-toggle="dropdown">
                                        <i data-feather="more-vertical"></i>
                                    </button>
                                    <div class="dropdown-menu dropdown-menu-end">
...
<div class="row" id="table-striped-dark">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <p class="card-text">
                    Use <code>.table-dark</code> with <code>.table-striped</code> to add zebra-striping to any inverse
                    table row
...
<div class="row" id="table-bordered">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <p class="card-text">
                    Add <code>.table-bordered</code> for borders on all sides of the table and cells. For Inverse Dark
                    Table, add
...
<div class="row" id="table-hover-row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <p class="card-text">
                    Add <code class="highlighter-rouge">.table-hover</code> to enable a hover state on table rows within
                    a
...
<div class="row" id="table-small">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <p class="card-text">
                    Add <code class="highlighter-rouge">.table-sm</code> class with <code>.table</code> to display small
                    size
                    table.
                </p>
            </div>
            <div class="table-responsive">
                <table class="table table-sm">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <img src="{{asset('images/icons/angular.svg')}}" class="me-75" alt="Angular" width="18"
                                    height="18" />
                                <span class="fw-bold">Angular Project</span>
                            </td>
                            <td>Peter Charls</td>
                        ...
                        <tr>
                            <td>
                                <img src="{{asset('images/icons/react.svg')}}" class="me-75" alt="React" width="18"
                                    height="18" />
                                <span class="fw-bold">React Project</span>
                            </td>
                            <td>Ronald Frest</td>
                        ...
                        <tr>
                            <td>
                                <img src="{{asset('images/icons/vuejs.svg')}}" class="me-75" alt="Vuejs" width="18"
                                    height="18" />
                                <span class="fw-bold">Vuejs Project</span>
                            </td>
                            <td>Jack Obes</td>
                        ...
                        <tr>
                            <td>
                                <img src="{{asset('images/icons/bootstrap.svg')}}" class="me-75" alt="Bootstrap"
                                    width="18" height="18" />
                                <span class="fw-bold">Bootstrap Project</span>
                            </td>
                            <td>Jerry Milton</td>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="card-text">
                    ...
                    <a href="https://getbootstrap.com/docs/4.3/content/tables/IDcontextual-classes"
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr class="table-default">
                            <td>
                                <img src="{{asset('images/icons/figma.svg')}}" class="me-75" height="20" width="20"
                                    alt="Figma" />
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info">
                    <div class="alert-body">
                        ...
                        <p>
                            Responsive tables make use of <code class="highlighter-rouge">overflow-y: hidden</code>,
                            which clips off
                            any content that goes beyond the bottom or top edges of the table. In particular, this can
                            clip off
