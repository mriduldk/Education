    ...
    <div class="card">
        ...
        <div class="card-body">
            <p class="card-text mb-0">
                ...
                animation:
                "success", "error", "warning" and "info". You can also set it as "input" to get a prompt modal. It can
                either be
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <button type="button" class="btn btn-outline-primary" id="confirm-color">Confirm Button
                        Color</button>
                </div>
            </div>
        </div>
