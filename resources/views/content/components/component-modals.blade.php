                ...
                <div class="card-body">
                    <div class="demo-inline-spacing">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p>
                                                ...
                                                carrot cake candy canes bonbon fruitcake topping halvah. Cake sweet roll
                                                cake cheesecake cookie
                        ...
                        <div class="disabled-backdrop-ex">
                            ...
                            <!-- Modal -->
                            <div class="modal fade text-start" id="backdrop" tabindex="-1"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="alert alert-success" role="alert">
                                                <div class="alert-body">
                                                    <span class="fw-bolder">Well done!</span> You successfully read this
                ...
                <div class="card-body">
                    ...
                    <div class="demo-inline-spacing">
                        <div class="d-inline-block">
                            ...
                            <!-- Modal -->
                            <div class="modal fade text-start modal-primary" id="primary" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            Pudding jelly beans
                                            carrot cake pastry gummies cheesecake lollipop. I love cookie lollipop cake
                                            I love sweet gummi
                        ...
                        <div class="d-inline-block">
                            ...
                            <!-- Modal -->
                            <div class="modal fade modal-secondary text-start" id="secondary" tabindex="-1"
                        ...
                        <div class="d-inline-block">
                            ...
                            <!-- Modal -->
                            <div class="modal fade modal-danger text-start" id="danger" tabindex="-1"
                        ...
                        <div class="d-inline-block">
                            ...
                            <!-- Modal -->
                            <div class="modal fade modal-info text-start" id="info" tabindex="-1"
                        ...
                        <div class="d-inline-block">
                            ...
                            <!-- Modal -->
                            <div class="modal fade modal-dark text-start" id="dark" tabindex="-1"
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-text mb-0">
                        Add class <code>.modal-{xs|sm|lg|xl}</code> with <code>.modal-dialog</code> to create a modal
                        with size
                    </p>
                    ...
                    <div class="demo-inline-spacing">
                        <div class="modal-size-xs d-inline-block">
                            ...
                            <!-- Modal -->
                            <div class="modal fade text-start" id="xSmall" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-xs">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Halvah powder wafer. Chupa chups pie topping carrot cake cake. Tootsie roll
                                            sesame snaps jelly-o
                        ...
                        <div class="modal-size-sm d-inline-block">
                            ...
                            <!-- Modal -->
                            <div class="modal fade text-start" id="small" tabindex="-1" aria-labelledby="myModalLabel19"
                                aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Biscuit chocolate cake gummies. Lollipop I love macaroon bear claw caramels.
                                            I love marshmallow
                                            tiramisu I love fruitcake I love gummi bears. Carrot cake topping liquorice.
                                            Pudding caramels
                        ...
                        <div class="modal-size-default d-inline-block">
                            ...
                            <!-- Modal -->
                            <div class="modal fade text-start" id="defaultSize" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            I love candy candy cake powder I love icing ice cream pastry. Biscuit lemon
                                            drops sesame snaps.
                            ...
                            <div class="modal fade text-start" id="large" tabindex="-1" aria-labelledby="myModalLabel17"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            I love tart cookie cupcake. I love chupa chups biscuit. I love marshmallow
                                            apple pie wafer
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-xl">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            pudding lollipop apple pie gummies dragée. Chocolate bar cookie caramels I
                                            love lollipop ice cream
                ...
                <div class="card-body">
                    <div class="demo-inline-spacing">
                        ...
                        <div class="show-event-ex">
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" id="onshowbtn"
                                data-bs-target="#onshow">
                                On Show Event
                            </button>
                            <!-- Modal -->
                            <div class="modal fade text-start" id="onshow" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            chocolate bar. Oat cake lollipop I love cake chocolate bar jelly sweet. I
                                            love cotton candy oat
                                            cake jelly.
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-primary"
                        ...
                        <div class="shown-event-ex">
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" id="onshownbtn"
                                data-bs-target="#onshown">
                                On Shown Event
                            </button>
                            <!-- Modal -->
                            <div class="modal fade text-start" id="onshown" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Jujubes chocolate bar topping sweet caramels chocolate cake. Fruitcake pie
                                            wafer toffee sweet roll
                        ...
                        <div class="hide-event-ex">
                            <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" id="onhidebtn"
                                data-bs-target="#onhide">
                                On Hide Event
                            </button>
                            <!-- Modal -->
                            <div class="modal fade text-start" id="onhide" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            claw bonbon dragée. Jujubes carrot cake jujubes I love lemon drops cookie.
                                            Jelly beans jujubes
                        ...
                        <div class="hidden-event-ex">
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                                id="onhiddenbtn" data-bs-target="#onhidden">
                                On Hidden Event
                            </button>
                            <!-- Modal -->
                            <div class="modal fade text-start" id="onhidden" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Cookie cupcake dessert cotton candy donut cupcake marshmallow pie marzipan.
                                            Tootsie roll wafer
                                            sesame snaps gummi bears cake. Cake icing cupcake I love gummi bears. Halvah
                                            I love chupa chups I
                                            love bonbon I love.
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-primary"
