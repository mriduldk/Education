...
<div class="auth-wrapper auth-cover">
    <div class="auth-inner row m-0">
        ...
        <a class="brand-logo" href="#">
            ...
            <h2 class="brand-text text-primary ms-1">BTR</h2>
        </a>
        <!-- /Brand logo-->
        ...
        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                <h2 class="card-title fw-bold mb-1">Welcome to BTR Education Officer Login</h2>
                ...
                <form class="auth-login-form mt-2" id="loginForm">
                    ...
                    <button class="btn btn-primary w-100" tabindex="4" id="btnSignin" type="submit">Sign in</button>
                </form>
            </div>
        </div>
        <!-- /Login-->
...
$("#btnSignin").click(function() {
    ...
    var officer_type = $('#officer_type').find(":selected").text();
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.status == 200) {
                ...
                if(officer_type == 'IS') {
                    window.location.replace("{{ url('is/dashboard') }}");

                } else if(officer_type == 'DPC') {

                    window.location.replace("{{ url('dpc/dashboard') }}");

                } else if(officer_type == 'DMC') {

                    window.location.replace("{{ url('dmc/dashboard') }}");

                } else if(officer_type == 'DEEO') {

                    window.location.replace("{{ url('deeo/dashboard') }}");

                } else if(officer_type == 'DI') {

                    window.location.replace("{{ url('di/dashboard') }}");
