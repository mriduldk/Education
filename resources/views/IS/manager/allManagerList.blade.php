                ...
                <div class="modal-body flex-grow-1">
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control dt-date" id="manager_type" name="manager_type"
                            placeholder="Manager Type" aria-label="Manager Type" value="IS" hidden />
                    </div>
                    <div class="mb-1">
...
$("tbody").on("click", "#editManager", function() {
    ...
    $.ajax({
        url: "{{ url('is/manager-data-for-edit') }}",
        method: "GET",
        data: {
            manager_id: id
        },
