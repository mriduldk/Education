...
@section('title', 'Image Categories')
...
<section id="basic-datatable">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <table class="datatables-image-category table">
                </table>
            </div>
        </div>
    </div>
...
<script>
    var i = 1;
var dt_latest_update_table = $('.datatables-image-category');
var datatable = dt_latest_update_table.DataTable({
    ...
    columnDefs: [
        ...
        },
        {
            ...
            render: function(data, type, full, meta) {
                ...
                return (
                    '<a id="deleteLatestUpdate" class="btn btn-danger delete-record" data-id="' + data.category_id  +
                    '" ">' +
    ...
    buttons: [{
        ...
        action : function (e, dt, node, config) {
            window.location.replace("{{url('insertImageCategory')}}");
        },
