...
@section('title', 'Teacher Personal Information')
                        ...
                        <li class="timeline-item">
                            ...
                            <div class="timeline-event">
                                <div class="d-flex justify-content-between flex-sm-row flex-column mb-sm-0 mb-1">
                                    <a href="{{ url('insertTeacher') }}" ><h6>Personal Information</h6></a>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-item">
                            ...
                            <div class="timeline-event">
                                <div class="d-flex justify-content-between flex-sm-row flex-column mb-sm-0 mb-1">
                                    <a href="{{ url('insertEmployeementDetails') }}" ><h6>Employeement Details</h6></a>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-item">
                            ...
                            <div class="timeline-event">
                                <div class="d-flex justify-content-between flex-sm-row flex-column mb-sm-0 mb-1">
                                    <a href="{{ url('insertSalaryAccount') }}" ><h6>Salary Account Details</h6></a>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-item">
                            ...
                            <div class="timeline-event">
                                <div class="d-flex justify-content-between flex-sm-row flex-column mb-sm-0 mb-1">
                                    <a href="{{ url('insertTeacherQualification') }}" ><h6>Qualification Details</h6></a>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-item">
                            ...
                            <div class="timeline-event">
                                <div class="d-flex justify-content-between align-items-center mb-50">
                                    <a href="{{ url('insertTeacherDocuments') }}" ><h6>Documents</h6></a>
                                    <!-- <div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control dt-full-name" id="teacher_first_name"
                                                name="teacher_first_name" placeholder="First Name"
                                                aria-label="First Name" value="{{ $teacher->teacher_first_name }}" />
                                    ...
                                    <div class="col-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control dt-date" id="teacher_employee_code"
                                                ...
                                                value="{{ $teacher->teacher_employee_code }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="date" class="form-control dt-date" id="teacher_dob"
                                                name="teacher_dob" placeholder="Date of Birth"
                                                aria-label="Date of Birth" value="{{ $teacher->teacher_dob }}" />
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-1">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control dt-date" id="teacher_nationality"
                                                name="teacher_nationality" placeholder="Nationality"
                                                aria-label="Nationality" value="{{ $teacher->teacher_nationality }}" />
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control dt-date" id="teacher_present_address"
                                                ...
                                                value="{{ $teacher->teacher_present_address }}" />
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control dt-date"
                                                id="teacher_parmanent_address" name="teacher_parmanent_address"
                                                placeholder="Parmanent Address" aria-label="Parmanent Address"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control dt-date" id="teacher_aadhaar_no"
                                                name="teacher_aadhaar_no" placeholder="Aadhaar No"
                                                aria-label="Aadhaar No" value="{{ $teacher->teacher_aadhaar_no }}" />
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control dt-date" id="teacher_mother_name"
                                                name="teacher_mother_name" placeholder="Mother Name"
                                                aria-label="Mother Name" value="{{ $teacher->teacher_mother_name }}" />
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control dt-date" id="teacher_father_name"
                                                name="teacher_father_name" placeholder="Father Name"
                                                aria-label="Father Name" value="{{ $teacher->teacher_father_name }}" />
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-1">
                                            <label class="form-label" for="teacher_identification_mark">Identificaion
                                                Mark</label>
                                            <input type="text" class="form-control dt-date"
                                                id="teacher_identification_mark" name="teacher_identification_mark"
                                                placeholder="Identificaion Mark" aria-label="Identificaion Mark"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control dt-date" id="teacher_blood_group"
                                                name="teacher_blood_group" placeholder="Blood Group"
                                                aria-label="Blood Group" value="{{ $teacher->teacher_blood_group }}" />
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-1">
                                            <label class="form-label" for="teacher_differntly_abled">Differently
                                                Abled</label>
                                            <input type="text" class="form-control dt-date"
                                                id="teacher_differntly_abled" name="teacher_differntly_abled"
                                                placeholder="Differently Abled" aria-label="Differently Abled"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control dt-date" id="teacher_maritial_status"
                                                ...
                                                value="{{ $teacher->teacher_maritial_status }}" />
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control dt-date" id="teacher_spouse_name"
                                                name="teacher_spouse_name" placeholder="Spouse Name"
                                                aria-label="Spouse Name" value="{{ $teacher->teacher_spouse_name }}" />
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-1">
                                            <label class="form-label"
                                                for="teacher_spouse_working_under_govt_serveice">Spouse
                                    ...
                                    <div class="col-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control dt-date" id="teacher_tet_category"
                                                name="teacher_tet_category" placeholder="TET Category"
                                                aria-label="TET Category"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control dt-date" id="teacher_category_type"
                                                name="teacher_category_type" placeholder="Designation"
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 200) {
                        ...
                        window.location.replace("{{ url('insertEmployeementDetails') }}");
