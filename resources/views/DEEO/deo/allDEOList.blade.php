                ...
                <div class="modal-body flex-grow-1">
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control dt-date" id="deo_type" name="deo_type"
                            placeholder="DEO Type" aria-label="DEO Type" value="DEEO" hidden />
                    </div>
                    <div class="mb-1">
...
$("tbody").on("click", "#editDEO", function() {
    ...
    $.ajax({
        url: "{{ url('deeo/deo-data-for-edit') }}",
        method: "GET",
        data: {
            deo_id: id
        },
