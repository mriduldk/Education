    ...
    <div class="row">
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/deeo/schoolList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/deeo/teacherList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/deeo/approverList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/deeo/managerList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/deeo/deoList') }}"><i data-feather='eye'></i> View</a>
            </div>
        </div>
...
var datatable = dt_notice_table.DataTable({
    ...
    destroy: true,
    ajax: {
        url: "{{ url('deeo/user-activity-data') }}",
        type: 'GET',
        dataSrc: ''
    },
