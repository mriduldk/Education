...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="{{ asset('images/logo/favicon1.ico') }}">
...
@isset($configData['mainLayoutType'])
  @extends((( $configData["mainLayoutType"] === 'horizontal') ? 'layouts.verticalLayoutMasterWithoutSidebar' :
  'layouts.verticalLayoutMasterWithoutSidebar' ))
@endisset
