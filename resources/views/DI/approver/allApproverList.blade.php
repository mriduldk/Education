                ...
                <div class="modal-body flex-grow-1">
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control dt-date" id="approver_type" name="approver_type"
                            placeholder="Approver Type" aria-label="Approver Type" value="DI" hidden />
                    </div>
                    <div class="mb-1">
...
$("tbody").on("click", "#editApprover", function() {
    ...
    $.ajax({
        url: "{{ url('di/approver-data-for-edit') }}",
        method: "GET",
        data: {
            approver_id: id
        },
