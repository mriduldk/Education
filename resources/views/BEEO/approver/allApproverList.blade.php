                ...
                <div class="modal-body flex-grow-1">
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control dt-date" id="approver_type" name="approver_type"
                            placeholder="Approver Type" aria-label="Approver Type" value="BEEO" hidden />
                    </div>
                    <div class="mb-1">
...
var datatable = dt_notice_table.DataTable({
    ...
    destroy: true,
    ajax: {
        url: "{{ url('beeo/all-approvers-data') }}",
        type: 'GET',
        dataSrc: ''
    },
...
$("tbody").on("click", "#editApprover", function() {
    ...
    $.ajax({
        url: "{{ url('beeo/approver-data-for-edit') }}",
        method: "GET",
        data: {
            approver_id: id
        },
