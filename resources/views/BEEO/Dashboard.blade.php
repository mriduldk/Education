    ...
    <div class="row">
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/beeo/schoolList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/beeo/teacherList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/beeo/approverList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/beeo/managerList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/beeo/deoList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
...
var datatable = dt_notice_table.DataTable({
    ...
    destroy: true,
    ajax: {
        url: "{{ url('beeo/user-activity-data') }}",
        type: 'GET',
        dataSrc: ''
    },
