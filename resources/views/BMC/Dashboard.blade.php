    ...
    <div class="row">
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/bmc/schoolList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/bmc/teacherList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/bmc/approverList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/bmc/managerList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/bmc/deoList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
...
var datatable = dt_notice_table.DataTable({
    ...
    destroy: true,
    ajax: {
        url: "{{ url('bmc/user-activity-data') }}",
        type: 'GET',
        dataSrc: ''
    },
