                ...
                <div class="modal-body flex-grow-1">
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control dt-date" id="deo_type" name="deo_type"
                            placeholder="DEO Type" aria-label="DEO Type" value="BMC" hidden />
                    </div>
                    <div class="mb-1">
