...
<section id="dashboard-ecommerce">
            ...
            <div class="card">
                <div class="card-body d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <span>Total Schools / Colleges</span>
                    </div>
            ...
            <div class="card">
                <div class="card-body d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <span>Pending Schools / Colleges</span>
                    </div>
    ...
    <h3 class="mt-50">Schools / Colleges</h3>
    <p class="mb-2">All Schools and Colleges in Dotma Block </p>
    <!-- table -->
        <div class="card">
        ...
        <table class="user-list-table table">
            <thead class="table-light">
                ...
                <th>Head Master / Principal Name</th>
                <th>Category</th>
                <th>Contact</th>
                <th>Status</th>
                <th>Actions</th>
