            ...
            <div class="card">
                <table class="datatable table">
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td>NO.319 KUMGURI LPS</td>
                            <td>18010102404</td>
                            <td>Dipankar Rabha</td>
                            <td>KUMGURI, CHANDRAPARA, KOKRAJHAR, Assam, 783370</td>
                            <td><span class="badge rounded-pill badge-light-success"> Registered </span></td>
                            <td><a class="btn btn-primary" href="{{url ('schoolDetails')}}">View</a></td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>NO.319 KUMGURI LPS</td>
                        ...
                        <tr>
                            ...
                            <td>Dipankar Rabha</td>
                            <td>KUMGURI, CHANDRAPARA, KOKRAJHAR, Assam, 783370</td>
                            <td><span class="badge rounded-pill badge-light-danger"> Not Registered </span></td>
                            <td><a class="btn btn-primary" href="{{url ('schoolDetails')}}">View</a></td>
                        </tr>
                        <tr>
                            <td>4</td>
