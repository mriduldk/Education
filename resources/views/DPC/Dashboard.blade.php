    ...
    <div class="row">
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/dpc/schoolList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/dpc/teacherList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/dpc/approverList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/dpc/managerList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/dpc/deoList') }}"><i data-feather='eye'></i> View</a>
            </div>
        </div>
...
var datatable = dt_notice_table.DataTable({
    ...
    destroy: true,
    ajax: {
        url: "{{ url('dpc/user-activity-data') }}",
        type: 'GET',
        dataSrc: ''
    },
