    ...
    <div class="row">
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/dmc/schoolList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/dmc/teacherList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/dmc/approverList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/dmc/managerList') }}"><i data-feather='eye'></i>
                    View</a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card">
                ...
                <a class="btn btn-gradient-primary" href="{{ url('/dmc/deoList') }}"><i data-feather='eye'></i> View</a>
            </div>
        </div>
...
var datatable = dt_notice_table.DataTable({
    ...
    destroy: true,
    ajax: {
        url: "{{ url('dmc/user-activity-data') }}",
        type: 'GET',
        dataSrc: ''
    },
