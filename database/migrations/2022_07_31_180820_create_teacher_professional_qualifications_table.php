...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('teacher_professional_qualifications', function (Blueprint $table) {
            $table->id();
            $table->string('teacehr_p_q_id')->unique();
    ...
    {
        Schema::dropIfExists('teacher_professional_qualifications');
    }
};
